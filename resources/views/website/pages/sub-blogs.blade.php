    ...
    <div class="row">
      <div class="mobile-view">
        <div class=" nav d-block nav-pills nav-pills-custom scrollmenu1" id="h-pills-tab" role="tablist">
          ...
          <a class="nav-link shadow tab-pane <?php if($key == 0) { echo "active"; } ?>" id="soilcharger-tab"
            data-toggle="tab" href="#blog_<?php  echo $key; ?>" role="tab" aria-controls="h-pills-home"
            aria-selected="true"><?php echo $frontblogarticlelist_data['title']; ?></a>
          <?php }?>
        </div>
        ...
        <div class="tab-scroll desktop-view">
          ...
          <div class="nav flex-column nav-pills nav-pills-custom" id="v-pills-tab" role="tablist"
            ...
            <a class="nav-link mb-3 p-3 shadow <?php if($key == 0) { echo "active"; } ?>" id="soilcharger-tab"
              data-toggle="pill" href="#blog_<?php  echo $key; ?>" role="tab" aria-controls="v-pills-home"
              aria-selected="true">
      ...
      <div class="col-md-9">
        ...
        <div class="tab-content" id="v-pills-tabContent">
          ...
          <div class="tab-pane fade  rounded bg-white show <?php if($key == 0) { echo "active"; } ?> p-5"
            id="blog_<?php  echo $key; ?>" role="tabpanel" aria-labelledby="soilcharger-tab">

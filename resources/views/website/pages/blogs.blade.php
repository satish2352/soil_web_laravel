    ...
    <div class="row justify-content-center blog-active">
      ...
      <div class="col-lg-3 col-md-6 card1">
        <div class="blog-post-item mb-30 mt-5">
          ...
          <h4><a><?php echo (mb_strlen($frontblogarticlelist_data['title'], 'UTF-8') > 20) ? mb_substr($frontblogarticlelist_data['title'], 0, 20, 'UTF-8') . '...' : $frontblogarticlelist_data['title']; ?></a></h4>

...
<section class="container-fluid bg-clr">
  ...
  <div class="career mt-3">
      ...
      <div class="">
          <div class="career-content">
              <a href="#" data-toggle="modal" type="button" data-target="#myModal29" class="btn" aria-expanded="true">Internship</a>
          </div>
      </div>
  </div>
  </div>
  ...
  <div class="career mb-5 mt-3">
      ...
      <div class="">
          <div class="career-content">
              <a href="#" data-toggle="modal" type="button" data-target="#myModal30" class="btn" aria-expanded="true">SCT Business Association</a>
          </div>
      </div>
  </div>
  </div>
  ...
  <div class="career mb-5 mt-3">
      ...
      <div class="">
          <div class="career-content">
              <a href="#" data-toggle="modal" type="button" data-target="#myModal31" class="btn" aria-expanded="true">Employment</a>
          </div>
      </div>
  </div>
  </div>
     ...
     <!--====================== Modal======================== -->
              <!-- modal1 start -->
             <div class="modal fade bd-example-modal-lg p_modal_text model-body" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="myModal29">
                                           ...
                                           <div class="form-row">
                                                               ...
                                                               <div class="form-group col-md-6">
                                                                   <label for="email"><b>Email :</b></label>
                                                                    <input type="email" class="form-control"  name="email" id="email" placeholder="Enter your Email addres abc@xyz.com" required="required">
                                                               </div>
                                           </div>
                                           <div class="form-row">
                                                               <div class="form-group col-md-6">
                                                                   <label for="mobile"><b>Mobile Number :</b></label>
                                                                   <input type="tel" class="form-control txtnum1" name="mobile" id="mobile" placeholder="Enter your mobile number" required="required">
                                                               </div>
                                                               <div class="form-group col-md-6">
                                                                   <label for="qualification"><b>Qualification :</b></label>
                                                                   <input type="text" class="form-control" name="qualification" id="qualification"  placeholder="Enter your Qualification" required="required">
                                                               </div>
                                           </div>
                                           <div class="form-group">
                                               <label for="address"><b>Address :</b></label>
                                               <textarea class="form-control"  rows="5" name="address" id="address" placeholder="Type Your address Here ...." required="required"></textarea>
                                           </div>
                                           <div class="form-group">
                                                               <label><b>Upload Resume :</b></label> 
                                                               <input type="file" class="form-control-file" name="resume" id="resume" onchange="getConvertinternship_form(this)"  required="required">
         ...
         <!-- modal2 start -->
          <div class="modal fade bd-example-modal-lg p_modal_text model-body" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="myModal30">
             <div class="modal-dialog modal-lg">
               <div class="modal-content">
                   <div class="modal-header">
                       <center>
                       ...
                       <div class="container">
                               ...
                               <!-- <form method="post"> -->
                                 <div class="form-row">
                                   <div class="form-group col-md-4">
                                     ...
                                     <input type="text" class="form-control txtname1" name="fname" id="fname" placeholder="Enter Your First Name" required="required">
                                   </div>
                                   <div class="form-group col-md-4">
                                     <label><b>Middel Name :</b></label>
                                     <input type="text" class="form-control txtname1" name="mname" id="mname" placeholder="Enter Your Middel Name" required="required">
                                   </div>
                                   <div class="form-group col-md-4">
                                     <label><b>Last Name :</b></label>
                                     <input type="text" class="form-control txtname1" name="lname" id="lname" placeholder="Enter Your Last Name" required="required">
                                   </div>
                                 </div>
                                 <div class="form-row">
                                   <div class="form-group col-md-4">
                                     <label for="mobno"><b>Mobile Number :</b></label>
                                     <input type="tel" class="form-control txtnum1" name="phone" id="phone" placeholder="Enter Your Mobile Number" required="required">
                                   </div>
                                   <div class="form-group col-md-4">
                                     <label for="mobno1"><b>Alternate Mobile Number :</b></label>
                                     <input type="tel" class="form-control txtnum1" name="alternate_mobile" id="alternate_mobile" placeholder="Enter Your Alternate Mobile Number" required="required">
                                   </div>
                                   <div class="form-group col-md-4">
                                     <label for="email20"><b>Email :</b></label>
                                     <input type="email" class="form-control" name="email" id="email" placeholder="Enter Your Email Address" required="required">
                                   </div>
                                 </div>
                                 <div class="form-row">
                                   <div class="form-group col-md-3">
                                     ...
                                     <?php foreach ($statelist as $key => $statelist_data) {?>
                                               <option value="<?php echo $statelist_data['location_id']; ?>"><?php echo $statelist_data['name']; ?></option>
                                      <?php  } ?>
                                      </select>
                                   </div>
                                   <div class="form-group col-md-3">
                                     <label for="district"><b>District :</b></label>
                                     <select class="custom-select my-1 mr-sm-2 personal_dist" id="district" name="district" required="required">
                                      
                                     </select>
                                   </div>
                                   <div class="form-group col-md-3">
                                     <label for="taluka"><b>Taluka :</b></label>
                                     <select class="custom-select my-1 mr-sm-2 personal_taluka" id="taluka" name="taluka" required="required">
                           ...
                           <div>
                               ...
                               <!-- <form method="post"> -->
                                 <div class="form-group">
                                   ...
                                   <textarea class="form-control" id="textadd1" rows="2" name="business_address" id="business_address" placeholder="Enter Your Address Details Here...." required="required"></textarea>
                                </div>
                                <div class="form-row">
                                   <div class="form-group col-md-3">
                                     <label for="state1"><b>State :</b></label>
                                      <select class="custom-select my-1 mr-sm-2 business_state" name="business_state" id="business_state" required="required">
                                      <option selected>Choose Your State</option>
                                      <?php foreach ($statelist as $key => $statelist_data) {?>
                                                <option value="<?php echo $statelist_data['location_id']; ?>"><?php echo $statelist_data['name']; ?></option>
                                        <?php  } ?>
                                   ...
                                   <div class="form-group col-md-3">
                                     <label for="district1"><b>District :</b></label>
                                      <select class="custom-select my-1 mr-sm-2 business_district" name="business_district" id="business_district" required="required">
                                      
                                     </select>
                                   </div>
                                   <div class="form-group col-md-3">
                                     <label for="taluka1"><b>Taluka :</b></label>
                                     <select class="custom-select my-1 mr-sm-2 business_taluka" name="business_taluka" id="business_taluka" required="required">
                                      
                                      </select>
                                   </div>
                                   <div class="form-group col-md-3">
                                     <label for="village1"><b>Village :</b></label>
                                     <select class="custom-select my-1 mr-sm-2" id="business_city" name="business_city" required="required">
                           ...
                           <div>
                               ...
                               <div class="form-row">
                                   ...
                                   <input type="file" class="form-control-file" name="aadhar_card_image_front" id="aadhar_card_image_front" onchange="getDistributor_aadhar_card_image_front(this)" required="required">
                                 </div>
                                 <div class="form-group col-md-6">
                                   ...
                                   <input type="file" class="form-control-file" name="aadhar_card_image_back" id="aadhar_card_image_back" onchange="getDistributor_aadhar_card_image_back(this)" required="required">
                                 </div>
                               </div>
                               <div class="form-row">
                                   <div class="form-group col-md-6">
                                   ...
                                   <input type="file" class="form-control-file" id="pan_card" name="pan_card" onchange="getDistributor_pan_card(this)" required="required">
                                 </div>
                                 <div class="form-group col-md-6">
                                   ...
                                   <input type="file" class="form-control-file" id="shop_act_image" onchange="getDistributor_shop_act_image(this)" name="shop_act_image" required="required">
                                 </div>
                               </div>
                               <div class="form-row">
                                   <div class="form-group col-md-6">
                                   ...
                                   <input type="file" class="form-control-file" name="light_bill" onchange="getDistributor_light_bill(this)" id="light_bill" required="required">
                                 </div>
                                 <div class="form-group col-md-6">
                                   ...
                                   <input type="file" class="form-control-file" id="product_purchase_bill" onchange="getDistributor_product_purchase_bill(this)" name="product_purchase_bill" required="required">
                                 </div>
                               </div>
                               <!-- </form> -->
                           </div>
                               ...
                               <!-- <form method="post"> -->
                                   <div class="form-row">
                                       <div class="form-group col-md-6">
                                         ...
                                         <div class="form-group col-md-6">
                                             <select class="custom-select my-1 mr-sm-2" name="where_open_shop" id="where_open_shop" required="required">
                                   ...
                                   <div class="form-row">
                                       <div class="form-group col-md-6">
                                         ...
                                         <div class="form-group col-md-6">
                                             <textarea class="form-control" id="why_want_take_distributorship" rows="1" name="why_want_take_distributorship" placeholder="Describe" required="required"></textarea>
                                         </div>
                                   </div>
                                   <div class="form-row">
                                       <div class="form-group col-md-6">
                                         ...
                                         <div class="form-group col-md-6">
                                             <textarea class="form-control" name="distributorship_exerience" id="distributorship_exerience" rows="1" placeholder="Describe" required="required"></textarea>
                                         </div>
                                   </div>
                                   <div class="form-row">
                                       <div class="form-group col-md-6">
                                         ...
                                         <div class="form-group col-md-6">
                                             <textarea class="form-control" name="experience_farm_garder" id="experience_farm_garder" rows="1" placeholder="Describe" required="required"></textarea>
                                         </div>
                                   </div>
                                   <div class="form-row">
                                       <div class="form-group col-md-6">
          ...
          <!-- model2 end -->
         <!-- model3 start -->
         <div class="modal fade bd-example-modal-lg p_modal_text model-body" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="myModal31">
         <div class="modal-dialog modal-lg">
           <div class="modal-content">
               <div class="modal-header">
                   <center>
                   ...
                   <form id="employment_form" method="post" enctype="multipart/form-data">
                                   ...
                                   <div class="form-row">
                                                       ...
                                                       <div class="form-group col-md-6">
                                                           ...
                                                           <input type="text" class="form-control" id="qualification" name="qualification" placeholder="Enter your Qualification" required="required">
                                                       </div>
                                   </div>
                                   <div class="form-row">
                                       <label  class="col-6"><b>Previous Experience :</b></label>
                                           <div class=" form-inline">
                                            <div class="col-2">
                                               ...
                                               <div class="col-4">
                                                   <input class="form-control" placeholder="To" type="date" value="" name="experience_from" id="experience_from" required="required">
                                                </div>
                                               <div class="col-1">
                                                   <label for="tope">To:</label>
                                               </div>
                                               <div class="col-4">
                                                   <input class="form-control" placeholder="To" type="date" value="" name="experience_to" id="experience_to" required="required">
                                               </div>
                                   ...
                                   <div class="form-group">
                                       ...
                                       <textarea class="form-control" name="address" id="address" rows="5" placeholder="Type Your address Here ...." required="required"></textarea>
                                   </div>
                                   <div class="form-group">
                                                       <label><b>Upload Resume :</b></label>
                                                       <input type="file" class="form-control-file" id="employment_resume" name="resume" onchange="getEmployment_resume(this)" required="required">
                                   </div>
                                  <!--  <center>
                                       <div class="form-group">
                                       <div class="g-recaptcha" data-sitekey="6LfKURIUAAAAAO50vlwWZkyK_G2ywqE52NU7YO0S" data-callback="verifyRecaptchaCallback" data-expired-callback="expiredRecaptchaCallback"></div>
            ...
            if(errorResponse.responseJSON.status_code==422)
                {
                  ...
                  $.each(errorResponse.responseJSON.message, function(key, value){
                      inputErrorMsg = value;
                      inputId=key;
                      $('#'+inputId).after('<label id='+inputId+'"-error" class="error" for="'+inputId+'">'+inputErrorMsg+'</label>')
                  });
                  $(".preloader").hide();
                }
                else{

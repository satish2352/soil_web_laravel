...
<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner my-4">
      <?php foreach($frontsliderlist as $key => $frontsliderlistdata ) { ?>
      <div class="carousel-item mt-4 <?php echo $key == 0 ? 'active' : ''; ?> banner0">
          <img src="<?php echo $frontsliderlistdata['photopath']; ?>" class="d-block w-100 carousel-img" alt="...">
                ...
                <div class="d-flex justify-content-center">
                    <div class="wrapper11">
                        ...
                        <div class="card-button d-flex justify-content-center">
                            <a data-toggle="modal" type="button" data-target="#export"
                                aria-expanded="true"><button>Shop
                                    Now</button></a>
                        </div>
                    </div>
                </div>
                ...
                <form method="post">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control txtname1"
                                placeholder="Enter Your Name/Company Name" required="required">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="inputmobile51"><b>Mobile Number :</b></label>
                            <input type="tel" class="form-control txtnum1" placeholder="Enter your Mobile Number"
                                required="required">
                        </div>
                    </div>
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="inputqualification51"
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control txtnum1" id="inputqualification51"
...
<div class="container-fluid pt-50 pb-50 bg-clr">
    ...
    <div class="row d-flex justify-content-center principle-section">
        ...
        <div class="col-md-3">
            <ul class="p-list">
                <li class="card" style="--accent-color: #9CC623" data-toggle="modal"
                    data-target="#principle-modal">
        ...
        <div class="col-md-3">
            <ul class="p-list">
                <li class="card" style="--accent-color: #F6911B" data-toggle="modal"
                    data-target="#principle-modal-2">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="color: black;">
                ...
                <ul style="list-style-type:circle;">
                    <li>A basal dose of krushi amrut, root charger, and Nutri charger should be given after every 60
                        days as per
                        the requirement of the plant.</li>
                    <li>In every application of soil or drip or drenching at least once in a week use soil charger 1ltr
                        and health
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body" style="color: black;">
                ...
                <ul>
                    <li>Watching daily videos posted on the youtube channel and preparing notes and comments. This is
                        the breath
                        of SCT VEDIC.</li>
                    <li>Study the articles published daily on the WhatsApp group. This is the water for SCT VEDIC users.
                    </li>
                    <li>For crop protection use only pest fighter, pest cleaner, disease fighter, and fungi cleaner. Do
                        not use
                        any chemicals. </li>
                </ul>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body" style="color: black;">
                ...
                <ul>
                    <li>Do not cultivate any soil that will cause movement or exposure. Mulching should not be done by
                        part of
                        trunk. </li>
                    ...
                    <li>3 -5 min of daily discussion with at least one new or old user farmer or with each other
                        directly or
...
$frontvisionlist_data) { ?>
                    <div class="org-frm-icon">
                        ...
                        <img src="{{ asset('img/images/organic_item_shape02.png') }}" alt=""
                            class="org-frm-icon-shape">
                    </div>
...
$frontphotogallerylistlimit_data) { ?>
                ...
                <li class="mix dev col-xl-3 col-md-4 col-12 col-sm-6 pd">
                    <img src="<?php echo $frontphotogallerylistlimit_data['photopath']; ?>" width="250px" itemprop="thumbnail" alt="Image description"
                        class="img-fluid" />
                    <div class="portfolio-overlay">
                        <div class="overlay-content">
                            ...
                            <a data-fancybox="item" title="click to zoom-in" href="<?php echo $frontphotogallerylistlimit_data['photopath']; ?>">
...
<section class="portfolio-section bg-clr" id="Video_Gallery">
 ...
 $webvideo_educationallimit_data) {?>
            ...
            <li class="mix col-xl-3 col-md-4 col-12 col-sm-6 pd">
                <iframe width="280" height="190" src="https://www.youtube.com/embed/<?php echo $webvideo_educationallimit_data['url']; ?>"
        ...
        <div class="row justify-content-center">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="section-title text-center mb-50">
                    ...
                    <p>Increase the soil fertility and strength of plant. Healthy plant development is our main aim.
                        From last
                        three years our technology experts Mr. Ram Mukhekar ji is educating and train farmers and want
                        to make them
                        independent for treatment and dicisions. Available platform to discuss various problems frankly
                        and
        ...
        <div class="row">
                ...
                <div class="career mt-3">
                    ...
                    <div class="">
                        <div class="career-content">
                            <a href="#" data-toggle="modal" type="button" data-target="#myModal29"
                                class="btn" aria-expanded="true">Internship</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                <div class="career mb-5 mt-3">
                    ...
                    <div class="">
                        <div class="career-content">
                            <a href="#" data-toggle="modal" type="button" data-target="#myModal30"
                                class="btn" aria-expanded="true">SCT Business Recruitment</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                <div class="career mb-5 mt-3">
                    ...
                    <div class="">
                        <div class="career-content">
                            <a href="#" data-toggle="modal" type="button" data-target="#myModal31"
                                class="btn" aria-expanded="true">Job Vacancy</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <form id="internship_form" enctype="multipart/form-data">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control txtname1" name="name" id="name"
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="tel" class="form-control txtnum1" name="mobile"
                                id="mobile"pattern="^(\+\d{1,3}[- ]?)?\d{10}$"
...
<div class="modal fade bd-example-modal-lg p_modal_text model-body" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <center>
                    <h5 class="modal-title" id="exampleModalLabel" style="color: black;">SCT Business Recruitment
                        Form</h5>
                </center>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    ...
                    <form id="distributor_form" method="post" enctype="multipart/form-data">
                        <div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control txtname1" name="fname"
                                        id="fname" placeholder="Enter Your First Name" required="required">
                                </div>
                                <div class="form-group col-md-4">
                                    <label><b>Middel Name :</b></label>
                                    <input type="text" class="form-control txtname1" name="mname"
                                        id="mname" placeholder="Enter Your Middel Name" required="required">
                                </div>
                                <div class="form-group col-md-4">
                                    <label><b>Last Name :</b></label>
                                    <input type="text" class="form-control txtname1" name="lname"
                                        id="lname" placeholder="Enter Your Last Name" required="required">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="tel" class="form-control txtnum1" name="alternate_mobile"
                                        id="alternate_mobile" placeholder="Enter Your Alternate Mobile Number"
                                        required="required">
                                </div>
                                <div class="form-group col-md-4">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    ...
                                    <select class="custom-select my-1 mr-sm-2 personal_state" id="state"
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select class="custom-select my-1 mr-sm-2 personal_dist" id="district"
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select class="custom-select my-1 mr-sm-2 personal_taluka" id="taluka"
                        ...
                        <div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    ...
                                    <select class="custom-select my-1 mr-sm-2 business_state" name="business_state"
                                        id="business_state" required="required">
                                        <option selected>Choose Your State</option>
                                        <?php foreach ($statelist as $key => $statelist_data) {?>
                                        <option value="<?php echo $statelist_data['location_id']; ?>"><?php echo $statelist_data['name']; ?>
                                        </option>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select class="custom-select my-1 mr-sm-2 business_district"
                                        name="business_district" id="business_district" required="required">

                                    </select>
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="taluka1"><b>Taluka :</b></label>
                                    <select class="custom-select my-1 mr-sm-2 business_taluka" name="business_taluka"
                                        id="business_taluka" required="required">

                                    </select>
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="village1"><b>Village :</b></label>
                                    <select class="custom-select my-1 mr-sm-2" id="business_city"
                                        name="business_city" required="required">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="file" class="form-control-file" name="aadhar_card_image_front"
                                        ...
                                        onchange="getDistributor_aadhar_card_image_front(this)" required="required">
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="file" class="form-control-file" name="aadhar_card_image_back"
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="file" class="form-control-file" id="shop_act_image"
                                        onchange="getDistributor_shop_act_image(this)" name="shop_act_image"
                                        required="required">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="file" class="form-control-file" name="light_bill"
                                        onchange="getDistributor_light_bill(this)" id="light_bill"
                                        required="required">
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="file" class="form-control-file" id="product_purchase_bill"
                                        onchange="getDistributor_product_purchase_bill(this)"
                                        name="product_purchase_bill" required="required">
                                </div>
                            </div>
                            <!-- </form> -->
                        </div>
                        ...
                        <div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <select class="custom-select my-1 mr-sm-2" name="where_open_shop"
                                        id="where_open_shop" required="required">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <select class="custom-select my-1 mr-sm-2" name="used_sct" id="used_sct"
                                        required="required">
                                        <option selected>Choose option...</option>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="textadd3"><b>* IF YOU USED THEN TELL YOUR EXPERIENCE & INFORMATION
                                            ?</b></label>
                                </div>
                                <div class="form-group col-md-6">
                                    <textarea class="form-control" name="distributorship_exerience" id="distributorship_exerience" rows="1"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="textadd5"><b>* HOW MANY FARMERS DO YOU WANT TO WORK WITH ? &
                ...
                <form id="employment_form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="tel" class="form-control txtnum1" name="mobile" id="mobile"
                                pattern="^(\+\d{1,3}[- ]?)?\d{10}$" placeholder="Enter your mobile number"
                                required="required">
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="form-row">
                        ...
                        <div class=" form-inline">
                            ...
                            <div class="col-4">
                                <input class="form-control" placeholder="To" type="date" value=""
                                    name="experience_from" id="experience_from" required="required">
                            </div>
                            <div class="col-1">
                            ...
                            <div class="col-4">
                                <input class="form-control" placeholder="To" type="date" value=""
                                    name="experience_to" id="experience_to" required="required">
                            </div>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $(function() {
                    ...
                    $.each(obj, function(i, item) {
                        console.log(item);
                        $('#business_district').append("<option value='" + item
                            .location_id +
                            "'>" + item.name + "</option>");
                    });
                });
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $(function() {
                    ...
                    $.each(obj, function(i, item) {
                        console.log(item);
                        $('#business_taluka').append("<option value='" + item
                            .location_id +
                            "'>" + item.name + "</option>");
                    });
                });
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $(function() {
                    ...
                    $.each(obj, function(i, item) {
                        console.log(item);
                        $('#business_city').append("<option value='" + item
                            .location_id +
                            "'>" + item.name + "</option>");
                    });
                });
...
$counter_list_data) { ?> -->
            ...
            <div class="col-sm-2 my-3">
                ...
                <div class="hr-b"></div>
                <p class="head2" data-max="{{ $counter_list_data['youtube_sus_count'] }}"> K <br>YOUTUBE SUBSCRIBER
                </p>
            </div>
            <div class="col-sm-2 my-3">
            ...
            <div class="col-sm-2 my-3">
                ...
                <p class="head2" data-max="{{ $counter_list_data['sem_meet_count'] }}" id="test"><br>SEMINAR
                    MEETING
                </p>
            </div>
            <div class="col-sm-2 my-3">
...
<div class="modal fade bd-example-modal-lg p_modal_text model-body" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <center>
                    <h5 class="modal-title" id="exampleModalLabel" style="color: black;">ENTER HERE OTP AND VERIFY
                    </h5>
                </center>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
            ...
            <div class="modal-body" style="color: black;">
                <form method="post">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <label for="inputmobile51"><b>Mobile Number :</b></label>
                            <input type="tel" class="form-control" id="txtnum"
                                placeholder="Enter your mobile number" required="required">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="file" class="form-control-file" id="exampleFormControlFile51"
                                required="required">
                        </div>
                        <div class="form-group col-md-6">
        ...
        <div class="row d-flex justify-content-center product-active" id="">
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="team-item">
                    ...
                    <img class="img-fluid rounded-circle w-100 mb-4" src="{{ asset('img/team/team1.png') }}"
                        alt="">
                    <div class="d-flex justify-content-center">
                        ...
                        <a class="btn-team btn-square text-primary bg-white m-1"
                            href="https://twitter.com/GoldenOpportu10" target="_blank"><i
                                class="fab fa-twitter"></i></a>
                        <a class="btn-team btn-square text-primary bg-white m-1"
                            href="https://www.linkedin.com/feed/?trk=IN-SEM_google-adwords_Jordan-brand-sign-up"
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="team-item">
                    ...
                    <img class="img-fluid rounded-circle w-100 mb-4" src="{{ asset('img/team/team2.png') }}"
                        alt="">
                    <div class="d-flex justify-content-center">
                        <a class="btn-team btn-square text-primary bg-white m-1"
                            href="https://www.facebook.com/Soil.Charger.Technology" target="_blank"><i
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="team-item">
                    ...
                    <img class="img-fluid rounded-circle w-100 mb-4" src="{{ asset('img/team/team3.png') }}"
                        alt="">
                    <div class="d-flex justify-content-center">
                        <a class="btn-team btn-square text-primary bg-white m-1"
                            href="https://www.facebook.com/Soil.Charger.Technology" target="_blank"><i
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                <div class="team-item">
                    ...
                    <img class="img-fluid rounded-circle w-100 mb-4" src="{{ asset('img/team/team5.png') }}"
                        alt="">
                    <div class="d-flex justify-content-center">
                        <a class="btn-team btn-square text-primary bg-white m-1"
                            href="https://www.facebook.com/Soil.Charger.Technology" target="_blank"><i
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                <div class="team-item">
                    ...
                    <img class="img-fluid rounded-circle w-100 mb-4" src="{{ asset('img/team/team4.png') }}"
                        alt="">
                    <div class="d-flex justify-content-center">
                        <a class="btn-team btn-square text-primary bg-white m-1"
                            href="https://www.facebook.com/Soil.Charger.Technology" target="_blank"><i
        ...
        <div class="iso-bg-clr">
            <div class="container-fluid pb-70 pt-50">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="iso-title">
                            <h1 class="text-center">AN <span class="iso">ISO 9001:2008</span> CERTIFIED COMPANY
                            </h1>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 px-0 justify-content-center">
                        <div class="iso-img">
                            <img src="{{ asset('img/iso/ISO.png') }}" class="mx-auto vert-move" alt=""
                                width="60%" height="auto">
                        </div>
                    </div>
                    <div class="col-lg-8  col-md-8 col-sm-12 ">
                        <div class="iso-info">
                            <p>At Soil Charger Technologies INC We know our responsibility to offer eco friendly
                                products and services
                                that efficiently satisfy the growing food, fuel, and fodder demands driven by social and
                                economic
                                development in a safe and sustainable manner.<br>
                                Our company is an leading biotech company who is active in the field of research,
                                manufacturing and

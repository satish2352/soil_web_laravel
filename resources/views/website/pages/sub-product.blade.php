        ...
        <div class="mob-view">
            ...
            <div class="nav d-block nav-pills nav-pills-custom scrollmenu" id="v-pills-tab" role="tablist">
              <?php foreach ($frontproductlist as $key => $frontproductlist_data) {?>
                    ...
                    href="#product_<?php echo $key; ?>" role="tab" aria-selected="<?php if($key==0) { echo "true"; } else { echo "false" ;} ?>">
                ...
                <!-- Tabs nav -->
                    ...
                    <?php foreach ($frontproductlist as $key => $frontproductlist_data) {?>
                        <a class="nav-link mb-3 p-3 shadow <?php if($key==0) { echo "active"; } ?>" id="soilcharger-tab" data-toggle="pill"
                         href="#product_<?php echo $key; ?>" role="tab" aria-controls="v-pills-home" 
          ...
          <div class="col-lg-9 col-xl-9 col-md-9 col-sm-12 col-xs-12">
              ...
              <div class="tab-content" id="v-pills-tabContent">
                  <?php foreach ($frontproductlist as $key => $frontproductlist_data) {?>
                    <div class="tab-pane fade  rounded bg-white show <?php if($key==0) { echo "active"; } ?> p-5" id="product_<?php echo $key; ?>" role="tabpanel" aria-labelledby="soilcharger-tab">
                          
                                  <h4 class="mb-4"><?php echo $frontproductlist_data['title']; ?></h4>

                              <div class="row s_product_img">
                                  <div class="col-lg-4 col-md-4 col-sm-6">
                                    <img src="<?php echo $frontproductlist_data['productphotopath']; ?>" class="img-fluid" alt="" srcset="">  
                                  </div>
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-lg-12 col-md-12 col-sm-12 mt-2">
                                      ...
                                      <form id="submit_review">
                                          <div class="form-row">
                                            <div class="col">
                                                <input type="hidden" class="form-control" id="product_id" name="product_id" value="<?php echo $frontproductlist_data['id']; ?>">
                                            ...
                                            <div class="col-12 mt-2 s_product_btn d-flex justify-content-center s_product_btn_new">
                                                <button type="button" id="saveDetails" value="Send Review">Send Review</button>
                                            </div>
                                          </div>
                                      </form>
                                  </div>

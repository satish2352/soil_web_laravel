      ...
      <div class="row justify-content-center">
        ...
        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 foot">
          ...
          <div class="footer-contact d-flex">
            ...
            <p class="ml-2">Shop No.3, lower ground flow, below passport office, star zone mall, Nashik - Pune highway,
              Nashik - 422 101</p>
          ...
          <div class="footer-contact d-flex">
            ...
            <p class="ml-2"><a href="callto:866 920 0221" style="color: #b5b6b7">+(91) 8669200221</a> <br> <a
                href="callto:866 920 0221" style="color: #b5b6b7">+(91) 9881798028</a></p>
          ...
          <div class="footer-nav-link ">
            <div class="row">
              ...
              <div class="col-lg-5 col-md-5 col-sm-5">
                <ul>
                  <li><span><i class="fa fa-home" aria-hidden="true"></i></span><a href="index.php">Home</a></li>
                  <li><span><i class="far fa-images" aria-hidden="true"></i></span><a href="#Photo_Gallery">Gallery</a>
                  </li>
                  <li><span><i class="fas fa-chalkboard-teacher" aria-hidden="true"></i></span><a
                      href="#career">Careers</a></li>
                  <li><span><i class="fas fa-blog" aria-hidden="true"></i></span><a href="#blog">&nbsp;Blogs</a></li>

                </ul>
              </div>
              <div class="col-xl-7 col-lg-7 col-md-7 col-sm-7">
                <ul>
                  <li><span><i class="far fa-address-card" aria-hidden="true"></i></span><a href="#about">Company
                      Profile</a></li>
                  <li><span><i class="fa fa-leaf" aria-hidden="true"></i></span><a href="#product">Products</a></li>
                  <li><span><i class="fas fa-map-marked-alt" aria-hidden="true"></i></span><a href="">Distribution</a>
                  </li>
              ...
              <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="footer-btn mt-4">
                  <center><a><button class="btn " data-toggle="modal" data-target="#footer-enquiry">Send
        ...
        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 foot">
          ...
          <div class="footer-contact">
            <p><i class="fa fa-globe" aria-hidden="true"></i><a href="#"><span>www.soilchargertechnology.com</span></a>
            </p>
          </div>
        ...
        <div class="col-xl-12 col-lg-12 col-md-12">
          <div class="footer-social mb-4 mt-3">
            <ul>
              <li class="hovicon effect-1 sub-a"><a href="https://www.facebook.com/Soil.Charger.Technology/"
                  target="_blank"><i class="fab fa-facebook-f"></i></a></li>
              <li class="hovicon effect-1 sub-a"><a href="https://twitter.com/GoldenOpportu10" target="_blank"><i
                    class="fab fa-twitter"></i></a></li>
              <li class="hovicon effect-1 sub-a"><a href="https://www.instagram.com/" target="_blank"><i
                    class="fab fa-instagram"></i></a></li>
              <li class="hovicon effect-1 sub-a"><a href="https://www.youtube.com/user/ramanu7985" target="_blank"><i
                    class="fab fa-youtube-square"></i></a></li>
              <li class="hovicon effect-1 sub-a"><a href="mailto:soilchargertec@gmail.com" target="_blank"><i
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12">
          <div class="copyright-text">
            <p class="text-center">©2022 All rights reserved<a href="#"> Soil Charger Technology</a></p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post">
          ...
          <input type="mobile" class="form-control mt-3" id="mobile_of_enq_person" name="mobile_of_enq_person"
            placeholder="Mobile Number" required="required">
          <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 mt-3">
              <div class="form-check">
                <input class="form-check-input products" name="products_all" type="checkbox" value="Super Soil Charger"
                  id="">
              ...
              <div class="form-check">
                <input class="form-check-input products" name="products_all" type="checkbox" value="Super Fruit Charger"
                  id="">
                <label class="form-check-label" for="">
                  Super Fruit Charger
                </label>
              ...
              <div class="form-check">
                <input class="form-check-input products" name="products_all" type="checkbox" value="Super Crop Charger"
                  id="">
                <label class="form-check-label" for="">
                  Super Crop Charger
                </label>
              ...
              <div class="form-check">
                <input class="form-check-input products" name="products_all" type="checkbox" value="Super Size Charger"
                  id="">
                <label class="form-check-label" for="">
                  Super Size Charger
                </label>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 mt-3">
              <div class="form-check">
                <input class="form-check-input products" name="products_all" type="checkbox" value="Super Water Charger"
                  id="">
                <label class="form-check-label" for="">
                  Super Water Charger
                </label>
              ...
              <div class="form-check">
                <input class="form-check-input products" name="products_all" type="checkbox" value="Super Fungi Charger"
                  id="">
                <label class="form-check-label" for="">
                  Super Fungi Charger
                </label>
              ...
              <div class="form-check">
                <input class="form-check-input products" name="products_all" type="checkbox" value="Super Pest Charger"
                  id="">
                <label class="form-check-label" for="">
                  Super Pest Charger
                </label>
              ...
              <div class="form-check">
                <input class="form-check-input products" name="products_all" type="checkbox" value="Krushi Amrut" id="">
                <label class="form-check-label" for="">
                  Krushi Amrut
                </label>
              </div>
              <div class="form-check">
                <input class="form-check-input products" name="products_all" type="checkbox" value="Green Gujrat" id="">
                <label class="form-check-label" for="">
                  Green Gujrat
                </label>
              </div>
